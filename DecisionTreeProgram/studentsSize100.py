...
#read files
dataSet = pd.read_csv('../DecisionTreeProgram/new100.csv') #you could add index_col=0 if there's an index

# dataSet = dataSet.sample(frac = 1, random_state=21)
# dataSet.to_csv('new100.csv',index=False)
...
print('Build Random Forest. Time: ', end)
